...
export default class App extends LitElement {
  ...
  constructor() {
    super();
    uSElectionsService.getYearModelList().then(data => this.uSElectionsYearModel = data);
  }
  ...
  @state()
  private uSElectionsYearModel: YearModel[] = [];
    ...
    return html`
      ...
      <div class="row-layout group_2">
        <igc-nav-drawer ?open="${true}" position="relative" id="nav-drawer" class="nav-drawer">
          ...
          ${this.uSElectionsYearModel?.map((item) => html`
